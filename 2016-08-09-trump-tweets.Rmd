...
description: Text and sentiment analysis on Trump's tweets confirms that the tweets
  posted from the iPhone appear to come from his campaign, while his tweets from Android
  are the 'off-the-cuff' observations he's known for.
category: r
